...
import { BeefIcon, TicketIcon, ChartIcon, UsersIcon, ArchivePlusIcon, ClipboardListIcon } from '../common/Icons.jsx';
...
const MainMenu = ({ onMenuSelect }) => {
    ...
    const MenuItem = ({ item }) => (
        <button 
            ...
            className="bg-gray-800 rounded-2xl p-6 flex flex-col items-center justify-center gap-4 aspect-square
        ...
        >
            <div className="text-amber-500 w-12 h-12">{item.icon}</div>
